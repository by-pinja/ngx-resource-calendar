...
import { DayModel, EventModel } from 'projects/ngx-resource-calendar/src/public-api';
...
export class AppComponent implements OnInit {
  ...
  public addEvents() {
    this.events = [
      { startTime: new Date('2020-01-30 12:00:00'), endTime: new Date('2020-01-30 12:15:00'), resourceNumber: 1 },
      { startTime: new Date('2020-01-30 12:30:00'), endTime: new Date('2020-01-30 13:15:00'), resourceNumber: 1 }
    ];
  }
